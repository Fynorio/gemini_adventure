...
export const RegisterPage: React.FC<RegisterPageProps> = ({ navigate }) => {
    ...
    return (
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg p-8 shadow-2xl max-w-md w-full mx-auto animate-fade-in">
            <h1 className="text-3xl font-serif-display text-center text-amber-300 mb-2">Create Your Account</h1>
            <p className="text-center text-gray-400 mb-8">Begin your journey here.</p>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                 ...
                 <p className="text-center text-sm text-gray-400">
                    ...
                    <a href="#/login" onClick={(e) => { e.preventDefault(); navigate('#/login'); }} className="font-semibold text-amber-400 hover:text-amber-300">
                        Log In
                    </a>
                </p>
            </form>
